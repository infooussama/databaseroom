...
import com.example.relationbdd.DetailMetroStation;
...
public class TramListAdapter extends RecyclerView.Adapter<TramListAdapter.ViewHolder> {

    private Activity context;
    private RoomDB database;
    private List<FullStation> dataList;
    private List<FullStation> filtredataList;
    public TramListAdapter(Activity context, List<FullStation> dataList){
    ...
    @NonNull
    @Override
    public TramListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_main_tram,parent,false);
        return new TramListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TramListAdapter.ViewHolder holder, int position) {
